...
7. Верни ответ строго в формате JSON, указанном ниже.

ФОРМАТ ОТВЕТА (СТРОГО ВАЛИДНЫЙ JSON, без преамбулы и markdown-обёртки):
...
{{
  ...
  "K5": <число от 1 до {w5}>,
  "K6": <число от 1 до {w6}>,
  "reasoning": "<обоснование строго до 4 предложений на русском (не более 400 символов): тип субъекта (с указанием маркера если он сыграл роль), роль столбца, ключевые аргументы по критериям>"
}}
